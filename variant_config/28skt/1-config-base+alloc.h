...
#define BYPASS_CATALOG				false
#define REPLICATE_ITEM				false
#define MAX_SOCKETS					32
#define ALLOW_READ_ONLY				false
#define BULK_INSERT					false
#define BATCHED_ACCESS				false

// [SPIN WAITING]
#ifdef SPIN_WAIT_BACKOFF
#undef SPIN_WAIT_BACKOFF
#endif  // SPIN_WAIT_BACKOFF
#define SPIN_WAIT_BACKOFF 			false
...
// deprecated #define INDEX_HASH_TYPE				IndexHash
