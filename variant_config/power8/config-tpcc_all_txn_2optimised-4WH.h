...
// [Index]
// Specifies the size of index insert and delete buffers
#define MAX_WRITE_SET				20

#define TPCC_ALL_TXN				true

#define DEBUG_CATALOG				false
#define BYPASS_CATALOG				true
#define REPLICATE_ITEM				true
#define MAX_SOCKETS					32
#define ALLOW_READ_ONLY				true
#define BULK_INSERT					true
#define BATCHED_ACCESS				true

// [SPIN WAITING]
#ifdef SPIN_WAIT_BACKOFF
#undef SPIN_WAIT_BACKOFF
#endif  // SPIN_WAIT_BACKOFF
#define SPIN_WAIT_BACKOFF 			true
#ifndef SPIN_WAIT_BACKOFF_MAX
#define SPIN_WAIT_BACKOFF_MAX 		15 // longest back-off time
#endif  // SPIN_WAIT_BACKOFF_MAX
// [ LATCH ]
#define LATCH_T						L_PTHREAD
//#define LATCH_T						L_SPIN
#define SCOPED_LATCH				false

#if SCOPED_LATCH
#define SCOPED_LATCH_T				L_QUEUE
#else
#define SCOPED_LATCH_T				LATCH_T
#endif  // SCOPED_LATCH

// [OCC,TICTOC,SILO]
// Deadlock prevention by spinning fixed number, no write-set ordering
#ifdef BOUNDED_SPINNING
#undef BOUNDED_SPINNING
#endif  // BOUNDED_SPINNING
#define BOUNDED_SPINNING			true

// [THREAD_ALLOC_HAWK]
#define MALLOC_TYPE					HAWK_ALLOC
#define THREAD_ALLOC_HAWK_INSERT	true
#define HAWK_ALLOC_CAPACITY			(1UL << 30)

/***********************************************/
// Simulation + Hardware
/***********************************************/
#define THREAD_CNT					384
//#define PART_CNT					1
...
#define CPU_FREQ 					(512.0/1000) 	// in GHz/s
...
// Number of spinning cycles for exponentiall back-off for bounded spinning
#ifndef BOUNDED_SPINNING_CYCLES
#define BOUNDED_SPINNING_CYCLES		15
#endif // BOUNDED_SPINNING_CYCLES
// [ INDEX ]
#define ENABLE_LATCH				false
#define CENTRAL_INDEX				false
#define CENTRAL_MANAGER 			false
// original IndexHash or optimised IndexHashTagged
#define INDEX_HASH_TAGGED_SIZE		10'000

#define INDEX_STRUCT				IDX_HASH_PERFECT
...
#define TS_CLOCK					4
// Latch types
#define L_PTHREAD					Latch_pthread
#define L_QUEUE						tbb::queuing_mutex
#define L_QUEUE_RW					tbb::queuing_rw_mutex
#define L_SPIN						tbb::spin_mutex
#define L_SPIN_RW					tbb::spin_rw_mutex
#define L_SPEC						tbb::speculative_spin_mutex
#define L_SPEC_RW					tbb::speculative_spin_rw_mutex
