...
#ifdef ALLOW_READ_ONLY
#undef ALLOW_READ_ONLY
...
#define L_QUEUE						Latch_tbb<tbb::queuing_mutex>
#define L_QUEUE_RW					Latch_tbb<tbb::queuing_rw_mutex>
#define L_SPIN						Latch_tbb<tbb::spin_mutex>
#define L_SPIN_RW					Latch_tbb<tbb::spin_rw_mutex>
#define L_SPEC						Latch_tbb<tbb::speculative_spin_mutex>
#define L_SPEC_RW					Latch_tbb<tbb::speculative_spin_rw_mutex>
